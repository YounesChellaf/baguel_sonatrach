                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header table-card-header">
                                    ...
                                    <a href="/admin/visit/create"><button class="btn btn-round btn-outline-success" data-toggle="modal" data-target="#modal-add-office">Ajouter une visite</button></a>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" class="office-add" action="/admin/office/{{$office->id}}">
                                ...
                                <div class="form-group">
                                    <label for="recipient-name" class="control-label">date entrée</label>
                                    <input type="date" class="form-control" id="recipient-name" name="in_date" >
                                </div>
                                <div class="form-group">
                                    <label for="recipient-name" class="control-label">date sortie</label>
                                    <input type="date" class="form-control" id="recipient-name" name="out_date" >
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-round btn-outline-danger waves-effect" data-dismiss="modal">Annuler</button>
