            ...
            <div class="page-wrapper">
                <div class="page-body">
                    <div class="container row" style="padding-bottom: 0.5%">
                        ...
                        <a href="{{route('admin.visitor.support.approve',$support->id)}}" id="add_row" class="btn btn-success pull-left">Valider la requete</a>
                        <a href="{{route('admin.visitor.support.reject',$support->id)}}" id="add_row" class="btn btn-danger pull-left">Rejeter la requete</a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            <div class="form-group row container">
                                ...
                                <div class="col-sm-4 row">
                                    <h4>organisme d'acceuil :</h4>
                                    <span style="padding-left: 5%">{{Service::find($support->service_id)->name}}</span>
                                </div>
                            </div>
                            <div class="form-group row container">
                                <div class="col-sm-4 row">
                            ...
                            <div class="form-group row container">
                                <div class="col-sm-4 row">
                                    <h4>nombre de repas:</h4>
                                    <span style="padding-left: 5%">{{$support->nb_repas}}</span>
                                </div>
                                <div class="col-sm-4 row">
                                    <h4>Imputation:</h4>
                            ...
                            <div class="form-group row">
                                <h4 class="col-sm-3">Visiteurs</h4>
                                <div class="col-md-8">
                                    <table class="table table-bordered table-hover" id="tab_logic">
                                        ...
                                        <tbody>
                                        @foreach($support->visitor as $visitor)
                                            <tr>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" class="service-add" action="{{ route('visitor.support.affect',$support->id) }}">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-sm-12">
