                ...
                <div class="page-body">
                    <div class="card">
                        <div class="card-header">
                            <h5>Les prises en charge internes avec imputation</h5>
                            <a href="{{ route('admin.support.create', 'intern-with-imputation') }}"><button type="button" style="float: right" class="btn btn-primary" name="button">Nouvelle réservation</button></a>
                        </div>
                        <div class="card-block">
                            <div class="dt-responsive table-responsive">
                                <table id="usersTable" class="table table-striped table-bordered nowrap">
                                    ...
                                    <tbody>
                                    @foreach(Support::where('type','with_imputation')->get() as $support)
                                        <tr>
                                            <td>{{$support->id}}</td>
