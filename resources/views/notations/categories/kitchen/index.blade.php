      ...
      <div class="page-body">
        <div class="card">
          <div class="card-header">
            <h5>Contrôl de cuisine</h5>
            <a href="{{ route('admin.notations.type.create', 'kitchen') }}"><button type="button" style="float: right" class="btn btn-primary" name="button">Nouveau Contrôl</button></a>
          </div>
