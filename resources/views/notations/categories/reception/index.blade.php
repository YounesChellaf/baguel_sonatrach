...
<div class="page-header card">
  <div class="row align-items-end">
    @include('notations.categories.reception.partials.pageTitle')
    @include('notations.categories.reception.partials.beadcrumbs')
  </div>
</div>
      ...
      <div class="page-body">
        <div class="card">
          <div class="card-header">
            <h5>Contrôl de reception de marchandises</h5>
            <a href="{{ route('admin.notations.type.create', 'reception') }}"><button type="button" style="float: right" class="btn btn-primary" name="button">Nouveau Contrôl</button></a>
          </div>
