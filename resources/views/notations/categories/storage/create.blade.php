      ...
      <div class="page-body">
        <div class="card">
          <div class="card-header">
            <h5>Nouveau Contrôl de magasin</h5>
          </div>
          <div class="card-block">
            ...
            @endif
            <form method="post" action="{{ route('admin.notations.type.save', 'storage') }}" class="NewExitPermissionForm">
              @csrf
              <div class="row">
              ...
              <input type="hidden" name="controlType" value="storage">
