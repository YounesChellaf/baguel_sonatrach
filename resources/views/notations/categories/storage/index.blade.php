      ...
      <div class="page-body">
        <div class="card">
          <div class="card-header">
            <h5>Contrôl de stockage & magasin</h5>
            <a href="{{ route('admin.notations.type.create', 'storage') }}"><button type="button" style="float: right" class="btn btn-primary" name="button">Nouveau Contrôl</button></a>
          </div>
