...
<div class="page-header card">
  <div class="row align-items-end">
    @include('notations.categories.office.partials.pageTitle')
    @include('notations.categories.office.partials.beadcrumbs')
  </div>
</div>
      ...
      <div class="page-body">
        <div class="card">
          <div class="card-header">
            <h5>Contrôl de Bureaux et locaux</h5>
            <a href="{{ route('admin.notations.type.create', 'office') }}"><button type="button" style="float: right" class="btn btn-primary" name="button">Nouveau Contrôl</button></a>
          </div>
