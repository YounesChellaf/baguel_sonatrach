...
<div class="page-header card">
  <div class="row align-items-end">
    @include('notations.categories.restaurant.partials.pageTitle')
    @include('notations.categories.restaurant.partials.beadcrumbs')
  </div>
</div>
      ...
      <div class="page-body">
        <div class="card">
          <div class="card-header">
            <h5>Contrôl de restaurant et foyer</h5>
            <a href="{{ route('admin.notations.type.create', 'restaurant') }}"><button type="button" style="float: right" class="btn btn-primary" name="button">Nouveau Contrôl</button></a>
          </div>
