      ...
      <div class="page-body">
        <div class="card">
          <div class="card-header">
            <h5>Nouveau Contrôl de cuisine</h5>
          </div>
          <div class="card-block">
            ...
            @endif
            <form method="post" action="{{ route('admin.notations.type.save', 'restaurant') }}">
              @csrf
              <div class="row">
                <div class="col-sm-12 col-xl-4 m-b-30">
                  <p>Date de contrôl</p>
                  <input class="form-control" name="controlDate" type="date" required value="{{ date('Y-m-d') }}" />
                </div>
                <div class="col-sm-12 col-xl-4">
                  <p>Heure de contrôl</p>
                  <input class="form-control" name="controlTime" type="time" value="{{ date('h:i:s') }}"/>
                </div>
              </div>
              ...
              <input type="hidden" name="controlType" value="restaurant">
