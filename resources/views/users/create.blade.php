        ...
        <div class="card">
          ...
          <div class="card-block">
            ...
            <form method="post" action="{{ route('admin.users.create.post') }}" class="NewUserForm">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Supérieur direct</label>
                <div class="col-sm-10">
                  <select class="form-control" name="superior">
                    <option value="">Sélectionner l'utilisateur supérieur direct</option>
                    @foreach(User::all() as $index => $superior)
